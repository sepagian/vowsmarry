...
export const load: PageServerLoad = async ({
	...
	const sortBy = url.searchParams.get("sortBy") || "expenseDueDate";
	...
	const [
		...
		getTableCount(plannerDb, TABLES.EXPENSES, activeWorkspaceId),
	...
	const [taskUpdate, expenseUpdate, documentUpdate, vendorUpdate] =
		await Promise.all([
