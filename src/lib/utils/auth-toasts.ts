...
export const authToasts = {
    success: {
        ...
        register: () => toast.success('Account created successfully! Please check your email to verify your account.'),
        logout: () => toast.success('You\'ve been logged out successfully. See you soon!'),
        passwordResetRequest: () => toast.info('Password reset email sent! Check your inbox for further instructions.'),
        passwordResetSuccess: () => toast.success('Password updated successfully! You can now log in with your new password.'),
        emailVerification: () => toast.success('Email verified successfully! You can now access all features.'),
    ...
    error: {
        ...
        emailNotConfirmed: () => toast.error('Please verify your email address before signing in. Check your inbox for the verification link.'),
        tooManyRequests: () => toast.error('Too many attempts. Please wait a moment before trying again.'),
        userNotFound: () => toast.error('No account found with this email address.'),

        // Registration errors
        emailAlreadyExists: () => toast.error('An account with this email already exists. Try logging in instead.'),
        ...
        passwordResetFailed: () => toast.error('Failed to send password reset email. Please try again.'),
        invalidResetToken: () => toast.error('Invalid or expired reset link. Please request a new password reset.'),
...
export function handleSupabaseAuthError(error: { message: string; status?: number }) {
    ...
    if (message.includes('invalid token') || message.includes('expired token') || message.includes('token')) {
