...
<div class="flex flex-col gap-6">
  ...
  <Card.Root>
    <Card.Header>
      ...
      <Card.Description
        >People who have access to this wedding workspace</Card.Description
      >
    </Card.Header>
    <Card.Content>
  ...
  {#if invitations && invitations.length > 0}
    <Card.Root>
      <Card.Header>
        ...
        <Card.Description
          >Invitations that haven't been accepted yet</Card.Description
        >
      </Card.Header>
      <Card.Content>
        <div class="space-y-4">
  ...
  <Card.Root class="border-destructive">
    <Card.Header>
      ...
      <Card.Description
        >Remove yourself from this wedding workspace</Card.Description
      >
    </Card.Header>
    <Card.Content>
      <Button
