...
export type Timestamp = ColumnType<Date, Date | string | number, Date | string | number>;
...
export type DowryType = 'cash' | 'gold' | 'jewelry' | 'fashion' | 'beauty' | 'furniture' | 'property' | 'other';
