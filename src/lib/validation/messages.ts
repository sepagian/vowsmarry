...
export const validationMessages: ValidationMessages = {
	...
	task: {
		description: {
			...
			highPriorityLength: 'High priority tasks require more detailed descriptions (at least 20 characters)'
		},
		category: {
		...
		priority: {
			...
			conditional: 'High priority tasks require more detailed descriptions'
		},
		status: {
