...
CREATE TYPE "public"."document_category" AS ENUM('legal_formal', 'vendor_finance', 'guest_ceremony', 'personal_keepsake');--> statement-breakpoint
...
CREATE TYPE "public"."user_role" AS ENUM('partner', 'planner', 'collaborator');--> statement-breakpoint
...
CREATE TABLE "schedules" (
	...
	"rundown_type" "rundown_type" NOT NULL,
...
CREATE TABLE "tasks" (
	...
	"task_category" "category" NOT NULL,
...
CREATE TABLE "users" (
	...
	"user_role" "user_role" DEFAULT 'partner',
	"avatar_url" varchar,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
...
CREATE TABLE "vendors" (
	...
	"phone" varchar(50),
	"website" varchar(50),
	"status" "vendor_status" DEFAULT 'researching' NOT NULL,
	"rating" "vendor_rating" NOT NULL,
...
ALTER TABLE "dresscodes" ADD CONSTRAINT "dresscodes_rundown_id_schedules_id_fk" FOREIGN KEY ("rundown_id") REFERENCES "public"."schedules"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "schedules" ADD CONSTRAINT "schedules_wedding_id_weddings_id_fk" FOREIGN KEY ("wedding_id") REFERENCES "public"."weddings"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "rundown_events_wedding_id_idx" ON "schedules" USING btree ("wedding_id");--> statement-breakpoint
CREATE INDEX "rundown_events_start_time_idx" ON "schedules" USING btree ("start_time");--> statement-breakpoint
...
CREATE INDEX "users_email_idx" ON "users" USING btree ("user_email");--> statement-breakpoint
CREATE INDEX "users_role_idx" ON "users" USING btree ("user_role");--> statement-breakpoint
