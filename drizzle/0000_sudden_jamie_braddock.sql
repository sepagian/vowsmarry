CREATE TYPE "public"."category" AS ENUM('accommodation', 'catering', 'decoration', 'entertainment', 'makeup-attire', 'paperwork', 'photo-video', 'venue', 'miscellaneous');--> statement-breakpoint
CREATE TYPE "public"."document_category" AS ENUM('legal_formal', 'vendor_finance', 'guest-ceremony', 'personal-keepsake');--> statement-breakpoint
...
CREATE TYPE "public"."dowry_type" AS ENUM('cash', 'gold', 'jewelry', 'property');--> statement-breakpoint
...
ALTER TABLE "dresscodes" ADD CONSTRAINT "dresscodes_rundown_id_rundowns_id_fk" FOREIGN KEY ("rundown_id") REFERENCES "public"."rundowns"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "gallery" ADD CONSTRAINT "gallery_wedding_id_invitations_id_fk" FOREIGN KEY ("wedding_id") REFERENCES "public"."invitations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "gallery" ADD CONSTRAINT "gallery_uploaded_by_guest_id_guests_id_fk" FOREIGN KEY ("uploaded_by_guest_id") REFERENCES "public"."guests"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "guests" ADD CONSTRAINT "guests_wedding_id_invitations_id_fk" FOREIGN KEY ("wedding_id") REFERENCES "public"."invitations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "savings_items" ADD CONSTRAINT "savings_items_saving_target_id_savings_summary_id_fk" FOREIGN KEY ("saving_target_id") REFERENCES "public"."savings_summary"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "expense_items_category_idx" ON "expense_items" USING btree ("expense_category");--> statement-breakpoint
...
CREATE INDEX "gallery_invitation_id_idx" ON "gallery" USING btree ("wedding_id");--> statement-breakpoint
...
CREATE INDEX "guests_invitation_id_idx" ON "guests" USING btree ("wedding_id");--> statement-breakpoint
...
CREATE INDEX "savings_items_goal_id_idx" ON "savings_items" USING btree ("saving_target_id");--> statement-breakpoint
